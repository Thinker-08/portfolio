...
const Contact = () => {
  const [det,setDet] = useState({name:"",email:"",message:""})
  const onChange=(e)=>{
  ...
  return (
    <div id="contact" className="flex flex-wrap w-6/6 h-auto pl-16 pb-8 bg-slate-300 rounded-2xl"> 
      ...
      <div
        className=" px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 text-gray-900 rounded-lg">
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Lets talk about everything!</h2>
            <div className="text-gray-700 mt-8">
              Hate forms? Send me an <span className="underline"><a href="mailto:agarwalmihir08@gmail.com">email</a></span> instead.
            </div>
          </div>
        ...
        <div className="shadow-2xl p-5 rounded-2xl">
          <div>
            ...
            <input className="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text" onChange={onChange} name="name" value={det.name} autoComplete="off" required/>
          </div>
          <div className="mt-8">
            <span className="uppercase text-sm text-gray-600 font-bold">Email</span>
            <input className="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="email" onChange={onChange} name="email" value={det.email} autoComplete="off" required/>
          </div>
          <div className="mt-8">
            <span className="uppercase text-sm text-gray-600 font-bold">Message</span>
            <textarea
              className="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              onChange={onChange} name="message" value={det.message} autoComplete="off" required></textarea>
          </div>
          <div className="mt-8">
            <input type="submit"
              className="uppercase text-sm tracking-wide  p-3 rounded-lg w-full focus:outline-none focus:shadow-outline
              transition ease-in-out delay-50 duration-200 hover:scale-105 hover:bg-blue-600 hover:text-white border-blue-600 border-2 text-blue-600 font-bold" value="Send Message">
            </input>
          </div>
        </div>
        </form>
