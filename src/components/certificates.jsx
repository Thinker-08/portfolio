...
const certificates = () => {
  return (
    <div id="certificates" className="pl-16 pt-16 pr-8 h-screen ">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 ">
        <div className="shadow-2xl  hover:border-blue-900 hover:border-2 hover:scale-105  transition ease-in-out delay-50 duration-500 w-full h-16 rounded-lg  pt-10 pb-32 hover:bg-slate-300 hover:h-64 hover:pt-16">
        ...
        <div className="shadow-lg hover:border-blue-900 hover:border-2 hover:scale-110 transition ease-in-out delay-50 duration-500 w-full h-16 rounded-lg  pt-10 pb-32 hover:bg-slate-300 hover:h-64 hover:pt-16">
