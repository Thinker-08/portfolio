      ...
      <div className="  bg-slate-300 flex flex-wrap pb-12 pl-16 change-intro-container" id="home">
        <div className="text-left flex-wrap  py-16 pl-10 rounded-full pr-2 change-intro">
          ...
          <p className="text-xl w-auto">
            ...
            <div className="my-10">
              <Link to="/about"><button className="transition ease-in-out delay-50 duration-200 hover:scale-105 bg-blue-500 hover:bg-blue-700 text-white font-bold py-5 px-7 mx-4 rounded-full" onClick={console.log("Clicked")}>
                About Me  
              </button></Link>
